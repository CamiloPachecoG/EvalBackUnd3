...
<body>
	...
	<div class="containet mt-5">
		<h1 class="text-center mt-5">Prueba N°3 Java Spring Boot</h1>
		<c:if test="${registrado != 1}">
		<div class="text-center mt-5 col-md-11 p-3 mb-2 bg-info text-white ml-5 align-items-center">
			<p>Para ver Las demas funcionalidades debes estar logeado!</p>
		</div>
		</c:if>
	</div>
